...
const { useAceEditor } = await dc.require(dc.headerLink("GitControl.component.v9.1.md", "UseAceEditor"));
const { useState, useEffect, useRef } = dc;
const { diff_match_patch, DIFF_DELETE, DIFF_INSERT, DIFF_EQUAL } = await dc.require(dc.headerLink("GitControl.component.v9.1.md", "diff_match_patch"));
...
const { loadScript } = await dc.require(dc.headerLink("GitControl.component.v9.1.md", "LoadScript"));
